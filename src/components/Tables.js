...
import { faAngleDown, faAngleUp, faSearch , faArrowDown, faArrowUp, faEdit, faEllipsisH, faExternalLinkAlt, faEye, faTrashAlt } from '@fortawesome/free-solid-svg-icons';
import { Col, Row, Nav, Card, Image, Button, Table, Dropdown, ProgressBar, Pagination, ButtonGroup } from '@themesberg/react-bootstrap';
import { Link } from 'react-router-dom';
import { useDispatch, useSelector } from "react-redux";
import { Form, Breadcrumb, InputGroup } from '@themesberg/react-bootstrap';
...
import clientUsers from "../data/clientUsers";
import Swal from "sweetalert2";
import {getAllAdmins,deleteAdmin } from "../actions/AdminActions";
...
//New table for Client Users, CRUD 

export const ClientUsersTable = () => {
  const TableRow = (props) => {
    const { clientInfo , name , email , contact , address } = props;
    ...
    <Card border="light" className="table-wrapper table-responsive shadow-sm">
      <Card.Body className="pt-0">
        <Table hover className="user-table align-items-center">
          ...
          <tbody>
            {clientUsers.map(c => <TableRow key={`clientUsers-${c.id}`} {...c} />)}
          </tbody>
        </Table>
        <Card.Footer className="px-3 border-0 d-lg-flex align-items-center justify-content-between">
          <Nav>
