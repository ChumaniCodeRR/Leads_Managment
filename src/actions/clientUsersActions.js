...
import { GET_CLIENT_USERS_SUCCESS , GET_CLIENT_USERS_FAILURE , ADD_CLIENT_USERS_SUCCESS, ADD_CLIENT_USERS_FAILURE, EDIT_CLIENT_USERS_SUCCESS, EDIT_CLIENT_USERS_FAILURE, DELETE_CLIENT_USERS_SUCCESS
    ...
    export const getAllClientUsers = () => (dispatch) => {
        return ClientUsersService.returnAllClientUsers().then((data) => {
            dispatch({
    ...
    export const ActOrDeactClientUsers = (id) = () => {
        return ClientUsersService.actOrdectClientUsers(id)
    }*/